...
class MetalLUTRenderer {
    ...
    init(targetWidth: Int = 1080, targetHeight: Int = 1440) throws {
        ...
        // Prime the pool to avoid first-frame hiccups
        primePixelBufferPool(minimumBufferCount: 8)
        
        print("✅ MetalLUTRenderer initialized for 3:4 output (with custom 1D tone curve + density + response-modulated grain + vignette)")
    }
